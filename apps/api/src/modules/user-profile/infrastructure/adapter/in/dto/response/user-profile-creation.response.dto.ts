...
/**
 * UserProfile 생성 성공 응답 DTO (Infrastructure Layer)
 * Controller에서 사용하는 HTTP API 전용 DTO
 */
export class UserProfileCreationResponseDto {
  @ApiProperty({
  ...
  constructor(profile: ApplicationResponseDto, message: string = "사용자 프로필이 성공적으로 생성되었습니다.") {
    this.profile = profile
    this.message = message
    this.profileId = profile.idx
  }
}
