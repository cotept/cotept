...
export class Migration20250824223100 implements MigrationInterface {
    name = 'Migration20250824223100'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS" DROP CONSTRAINT "PK_551cbf43600418b23a3ea02d26a"
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD "idx" number GENERATED BY DEFAULT AS IDENTITY
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD CONSTRAINT "PK_ab1bdf2195f15d4175073baf559" PRIMARY KEY ("idx")
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD "userId" varchar2(36) NOT NULL
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD CONSTRAINT "UQ_20e6bc36f8dd794f59be7037fec" UNIQUE ("userId")
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS"
        ...
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD "created_at" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_48982e7c3cbc9dd285f03593db8" FOREIGN KEY ("user_id") REFERENCES "USERS" ("idx") ON DELETE CASCADE
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "AUTH_VERIFICATIONS" DROP CONSTRAINT "FK_48982e7c3cbc9dd285f03593db8"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS" DROP CONSTRAINT "UQ_20e6bc36f8dd794f59be7037fec"
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS" DROP COLUMN "userId"
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS" DROP CONSTRAINT "PK_ab1bdf2195f15d4175073baf559"
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS" DROP COLUMN "idx"
        `);
        await queryRunner.query(`
            ALTER TABLE "USERS"
        ...
        await queryRunner.query(`
            ALTER TABLE "USERS"
            ADD CONSTRAINT "PK_551cbf43600418b23a3ea02d26a" PRIMARY KEY ("user_id")
        `);
        await queryRunner.query(`
