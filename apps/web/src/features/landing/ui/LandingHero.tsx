    ...
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden pb-20 pt-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <div className="mb-16 flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="mb-6 text-5xl font-black leading-[1.1] tracking-[-0.05em] md:text-7xl">
          ...
          <p className="mb-6 max-w-3xl text-base font-semibold leading-relaxed text-zinc-400 md:text-xl">
