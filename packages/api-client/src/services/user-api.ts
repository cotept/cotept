...
export const UserApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async changePassword(
      ...
      changePasswordRequestDto: ChangePasswordRequestDto,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PasswordChangeResponseWrapper>> {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["UserApi.changePassword"]?.[localVarOperationServerIndex]?.url
    ...
    async createUser(
      createUserRequestDto: CreateUserRequestDto,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserResponseWrapper>> {
    ...
    async deleteUser(
      ...
      deleteUserRequestDto: DeleteUserRequestDto,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserDeletionResponseWrapper>> {
    ...
    async getAllUsers(
      ...
      status?: GetAllUsersStatus,
      options?: RawAxiosRequestConfig,
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserListResponseWrapper>> {
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     */
    changePassword(
      requestParameters: UserApiChangePasswordRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PasswordChangeResponseWrapper> {
      return localVarFp
        .changePassword(requestParameters.id, requestParameters.changePasswordRequestDto, options)
    ...
    createUser(
      ...
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<UserResponseWrapper> {
      return localVarFp
        .createUser(requestParameters.createUserRequestDto, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * 사용자를 삭제합니다.
    ...
    deleteUser(
      ...
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<UserDeletionResponseWrapper> {
      return localVarFp
        .deleteUser(requestParameters.id, requestParameters.deleteUserRequestDto, options)
        .then((request) => request(axios, basePath))
    },
    /**
     * 등록된 모든 사용자 목록을 조회합니다.
    ...
    updateUser(
      ...
      return localVarFp
        .updateUser(requestParameters.id, requestParameters.updateUserRequestDto, options)
        .then((request) => request(axios, basePath))
    },
  }
}
